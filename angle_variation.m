...
r3=1.09;
Nt3=8; %number of bilayers to be used
ta5=62.5e-9;
tb5=115e-9;
...
theta_d=30;         %angle of incidence at the slab in degrees
...
n81 = [n_1,repmat([nb,na],1,Nt+2),nb];%,na,nb];
...
n83 = [n_1,repmat([nb,na],1,Nt3+1),nb];%,na,nb];
l83_gp=[repmat([nb*tb5,na*ta5],1,1),newt3(1:2*Nt3)];%,nb*(164e-9),na*(89e-9)];
